...
# we'll be looking at data on Groundhog predictions from https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-01-30
...
# create a subset of your data where "shadow" has a value of either TRUE or FALSE. 
# Make sure there are no duplicate rows
# sort the result by descending year
...
# create a summary table that gives the rate at which each type of groundhog sees its' shadow
predictions |>
